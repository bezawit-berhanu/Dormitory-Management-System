        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<int>(type: "int", nullable: false),
                    EmergencyContactNumber_FullName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    EmergencyContactNumber_PhoneNumber = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    EmergencyContactNumber_Relationship = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ComplaintResponses_Complaints_ComplaintId1",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ComplaintResponses_ComplaintId1",
                table: "ComplaintResponses",
                column: "ComplaintId1");
