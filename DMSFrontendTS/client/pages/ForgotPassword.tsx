  ...
  return (
    <main className="min-h-screen bg-[#062b25] text-white">
      <div className="mx-auto flex min-h-screen w-full max-w-6xl items-center justify-center px-5 py-10 sm:px-10">
        <section className="grid w-full overflow-hidden rounded-3xl border border-white/8 bg-[#f3efe5] text-[#143832] shadow-2xl lg:grid-cols-[.85fr_1.15fr]">
          <div className="relative hidden min-h-155 overflow-hidden bg-[#0a4439] p-10 text-white lg:flex lg:flex-col lg:justify-between">
            <div className="absolute -left-28 top-1/2 h-128 w-lg rounded-full border border-emerald-300/10 [box-shadow:0_0_0_70px_rgba(52,211,153,.025),0_0_0_140px_rgba(52,211,153,.02)]" />
          ...
          <div className="flex min-h-155 items-center px-6 py-10 sm:px-12 lg:px-16">
              ...
              <div className="mt-12">
               ...
               {submitted ? (
                <div className="mt-8 space-y-5">
                  <div className="rounded-2xl border border-emerald-200 bg-emerald-50 px-4 py-4 text-sm leading-6 text-emerald-800">If an account exists for that email, a reset link has been sent. Check your inbox and spam folder.</div>
                  <Link to="/" className="group flex h-12 w-full items-center justify-center gap-2 rounded-xl bg-[#0d594a] text-sm font-semibold text-white transition hover:bg-[#0a473c]">Return to sign in<ArrowRight className="h-4 w-4 transition-transform group-hover:translate-x-1" /></Link>
                </div>
               ) : (
